...
markov_model <- function(l_params_all, err_stop = FALSE, verbose = FALSE, checks = FALSE, cali = FALSE){
  ...
  if(cali == TRUE){
    # Calibration periods
    n_t <- (n_cali_max_per + 1) # if calibrating, cut model off at max calibration output (e.g. 48 months for four-years)
  } else{
  ...
  p_OD <- function(rate,
    ...
    # Generate time-varying probability of fentanyl exposure
      v_fent_exp_prob <- c(p_fent_exp_2017, p_fent_exp_2018, p_fent_exp_2019, p_fent_exp_2020)
  ...
  if(checks){
    ...
    write.csv(m_remain_4,"checks/state-time dependent transitions/m_TDP_4.csv", row.names = TRUE)
    ...
    write.csv(m_leave_4,"checks/state-time dependent transitions/m_leave_4.csv", row.names = TRUE)
  } else{}
  ...
  v_mort <- function(hr = hr, per = per){
    v_mort <- rep((1 - exp(-v_r_mort_by_age[n_age_init:(n_age_max - 1), ] * (1/per) * hr)), each = per) #in months
    return(v_mort)
  }
  # Non-injection
  ...
  # From BUP
  # First month
  a_UP_first[BUP & NI, BUPC & NI, i] <- p_BUP_BUPC_NI
  a_UP_first[BUP & NI, MET & NI, i]  <- p_BUP_MET_NI
  a_UP_first[BUP & NI, METC & NI, i] <- p_BUP_METC_NI
  a_UP_first[BUP & NI, ABS & NI, i]  <- p_BUP_ABS_NI
  a_UP_first[BUP & NI, REL & NI, i]  <- p_BUP_REL_NI
  # Month 2+
  a_UP[BUP & NI, BUPC & NI, i] <- p_BUP_BUPC_NI
  a_UP[BUP & NI, MET & NI, i]  <- p_BUP_MET_NI
  a_UP[BUP & NI, METC & NI, i] <- p_BUP_METC_NI 
  a_UP[BUP & NI, ABS & NI, i]  <- p_BUP_ABS_NI 
  a_UP[BUP & NI, REL & NI, i]  <- p_BUP_REL_NI

  # From BUPC
  # First month
  a_UP_first[BUPC & NI, BUP & NI, i]  <- p_BUPC_BUP_NI
  a_UP_first[BUPC & NI, MET & NI, i]  <- p_BUPC_MET_NI
  a_UP_first[BUPC & NI, METC & NI, i] <- p_BUPC_METC_NI
  a_UP_first[BUPC & NI, ABS & NI, i]  <- p_BUPC_ABS_NI
  a_UP_first[BUPC & NI, REL & NI, i]  <- p_BUPC_REL_NI
  # Month 2+
  a_UP[BUPC & NI, BUP & NI, i]  <- p_BUPC_BUP_NI
  a_UP[BUPC & NI, MET & NI, i]  <- p_BUPC_MET_NI
  a_UP[BUPC & NI, METC & NI, i] <- p_BUPC_METC_NI
  a_UP[BUPC & NI, ABS & NI, i]  <- p_BUPC_ABS_NI
  a_UP[BUPC & NI, REL & NI, i]  <- p_BUPC_REL_NI
  ...
  # Month 2+
  a_UP[MET & NI, METC & NI, i] <- p_MET_METC_NI
  a_UP[MET & NI, BUP & NI, i]  <- p_MET_BUP_NI
  a_UP[MET & NI, BUPC & NI, i]  <- p_MET_BUPC_NI
  a_UP[MET & NI, ABS & NI, i]  <- p_MET_ABS_NI
  a_UP[MET & NI, REL & NI, i]  <- p_MET_REL_NI

  # From METC
  # First month
  a_UP_first[METC & NI, MET & NI, i]  <- p_METC_MET_NI
  a_UP_first[METC & NI, BUP & NI, i]  <- p_METC_BUP_NI
  a_UP_first[METC & NI, BUPC & NI, i] <- p_METC_BUPC_NI
  a_UP_first[METC & NI, ABS & NI, i]  <- p_METC_ABS_NI
  a_UP_first[METC & NI, REL & NI, i]  <- p_METC_REL_NI
  
  # Month 2+
  a_UP[METC & NI, MET & NI, i]  <- p_METC_MET_NI
  a_UP[METC & NI, BUP & NI, i]  <- p_METC_BUP_NI
  a_UP[METC & NI, BUPC & NI, i] <- p_METC_BUPC_NI
  a_UP[METC & NI, ABS & NI, i]  <- p_METC_ABS_NI
  a_UP[METC & NI, REL & NI, i]  <- p_METC_REL_NI
  
  # From ABS
  # First month
  a_UP_first[ABS & NI, REL & NI, i]  <- p_ABS_REL_NI
  a_UP_first[ABS & NI, MET & NI, i]  <- p_ABS_MET_NI
  a_UP_first[ABS & NI, METC & NI, i] <- p_ABS_METC_NI
  a_UP_first[ABS & NI, BUP & NI, i]  <- p_ABS_BUP_NI
  a_UP_first[ABS & NI, BUPC & NI, i] <- p_ABS_BUPC_NI
  
  # Month 2+
  a_UP[ABS & NI, REL & NI, i]  <- p_ABS_REL_NI
  a_UP[ABS & NI, MET & NI, i]  <- p_ABS_MET_NI
  a_UP[ABS & NI, METC & NI, i] <- p_ABS_METC_NI
  a_UP[ABS & NI, BUP & NI, i]  <- p_ABS_BUP_NI
  a_UP[ABS & NI, BUPC & NI, i] <- p_ABS_BUPC_NI
  
  # From REL
  # First month
  a_UP_first[REL & NI, MET & NI, i]  <- p_REL_MET_NI
  a_UP_first[REL & NI, METC & NI, i] <- p_REL_METC_NI
  a_UP_first[REL & NI, BUP & NI, i]  <- p_REL_BUP_NI
  a_UP_first[REL & NI, BUPC & NI, i] <- p_REL_BUPC_NI
  a_UP_first[REL & NI, ABS & NI, i]  <- p_REL_ABS_NI
  
  # Month 2+
  a_UP[REL & NI, MET & NI, i]  <- p_REL_MET_NI
  a_UP[REL & NI, METC & NI, i] <- p_REL_METC_NI
  a_UP[REL & NI, BUP & NI, i]  <- p_REL_BUP_NI
  a_UP[REL & NI, BUPC & NI, i] <- p_REL_BUPC_NI
  a_UP[REL & NI, ABS & NI, i]  <- p_REL_ABS_NI
  ...
  # From BUP
  # First month
  a_UP_first[BUP & INJ, BUPC & INJ, i] <- p_BUP_BUPC_INJ
  a_UP_first[BUP & INJ, MET & INJ, i]  <- p_BUP_MET_INJ
  a_UP_first[BUP & INJ, METC & INJ, i] <- p_BUP_METC_INJ
  a_UP_first[BUP & INJ, ABS & INJ, i]  <- p_BUP_ABS_INJ
  a_UP_first[BUP & INJ, REL & INJ, i]  <- p_BUP_REL_INJ
  
  # Month 2+
  a_UP[BUP & INJ, BUPC & INJ, i] <- p_BUP_BUPC_INJ
  a_UP[BUP & INJ, MET & INJ, i]  <- p_BUP_MET_INJ
  a_UP[BUP & INJ, METC & INJ, i] <- p_BUP_METC_INJ
  a_UP[BUP & INJ, ABS & INJ, i]  <- p_BUP_ABS_INJ
  a_UP[BUP & INJ, REL & INJ, i]  <- p_BUP_REL_INJ
  
  # From BUPC
  # First month
  a_UP_first[BUPC & INJ, BUP & INJ, i]  <- p_BUPC_BUP_INJ
  a_UP_first[BUPC & INJ, MET & INJ, i]  <- p_BUPC_MET_INJ
  a_UP_first[BUPC & INJ, METC & INJ, i] <- p_BUPC_METC_INJ
  a_UP_first[BUPC & INJ, ABS & INJ, i]  <- p_BUPC_ABS_INJ
  a_UP_first[BUPC & INJ, REL & INJ, i]  <- p_BUPC_REL_INJ
  
  # Month 2+
  a_UP[BUPC & INJ, BUP & INJ, i]  <- p_BUPC_BUP_INJ
  a_UP[BUPC & INJ, MET & INJ, i]  <- p_BUPC_MET_INJ
  a_UP[BUPC & INJ, METC & INJ, i] <- p_BUPC_METC_INJ
  a_UP[BUPC & INJ, ABS & INJ, i]  <- p_BUPC_ABS_INJ
  a_UP[BUPC & INJ, REL & INJ, i]  <- p_BUPC_REL_INJ
  
  # From MET
  # First month
  a_UP_first[MET & INJ, METC & INJ, i] <- p_MET_METC_INJ
  a_UP_first[MET & INJ, BUP & INJ, i]  <- p_MET_BUP_INJ
  a_UP_first[MET & INJ, BUPC & INJ, i]  <- p_MET_BUPC_INJ
  a_UP_first[MET & INJ, ABS & INJ, i]  <- p_MET_ABS_INJ
  a_UP_first[MET & INJ, REL & INJ, i]  <- p_MET_REL_INJ
  
  # Month 2+
  a_UP[MET & INJ, METC & INJ, i] <- p_MET_METC_INJ
  a_UP[MET & INJ, BUP & INJ, i]  <- p_MET_BUP_INJ
  a_UP[MET & INJ, BUPC & INJ, i]  <- p_MET_BUPC_INJ
  a_UP[MET & INJ, ABS & INJ, i]  <- p_MET_ABS_INJ
  a_UP[MET & INJ, REL & INJ, i]  <- p_MET_REL_INJ
  
  # From METC
  # First month
  a_UP_first[METC & INJ, MET & INJ, i]  <- p_METC_MET_INJ
  a_UP_first[METC & INJ, BUP & INJ, i]  <- p_METC_BUP_INJ
  a_UP_first[METC & INJ, BUPC & INJ, i] <- p_METC_BUPC_INJ
  a_UP_first[METC & INJ, ABS & INJ, i]  <- p_METC_ABS_INJ
  a_UP_first[METC & INJ, REL & INJ, i]  <- p_METC_REL_INJ
  
  # Month 2+
  a_UP[METC & INJ, MET & INJ, i]  <- p_METC_MET_INJ
  a_UP[METC & INJ, BUP & INJ, i]  <- p_METC_BUP_INJ
  a_UP[METC & INJ, BUPC & INJ, i] <- p_METC_BUPC_INJ
  a_UP[METC & INJ, ABS & INJ, i]  <- p_METC_ABS_INJ
  a_UP[METC & INJ, REL & INJ, i]  <- p_METC_REL_INJ
  
  # From ABS
  # First month
  a_UP_first[ABS & INJ, REL & INJ, i]  <- p_ABS_REL_INJ
  a_UP_first[ABS & INJ, MET & INJ, i]  <- p_ABS_MET_INJ
  a_UP_first[ABS & INJ, METC & INJ, i] <- p_ABS_METC_INJ
  a_UP_first[ABS & INJ, BUP & INJ, i]  <- p_ABS_BUP_INJ
  a_UP_first[ABS & INJ, BUPC & INJ, i] <- p_ABS_BUPC_INJ
  
  # Month 2+
  a_UP[ABS & INJ, REL & INJ, i]  <- p_ABS_REL_INJ
  a_UP[ABS & INJ, MET & INJ, i]  <- p_ABS_MET_INJ
  a_UP[ABS & INJ, METC & INJ, i] <- p_ABS_METC_INJ
  a_UP[ABS & INJ, BUP & INJ, i]  <- p_ABS_BUP_INJ
  a_UP[ABS & INJ, BUPC & INJ, i] <- p_ABS_BUPC_INJ
  
  # From REL
  # First month
  a_UP_first[REL & INJ, MET & INJ, i]  <- p_REL_MET_INJ
  a_UP_first[REL & INJ, METC & INJ, i] <- p_REL_METC_INJ
  a_UP_first[REL & INJ, BUP & INJ, i]  <- p_REL_BUP_INJ
  a_UP_first[REL & INJ, BUPC & INJ, i] <- p_REL_BUPC_INJ
  a_UP_first[REL & INJ, ABS & INJ, i]  <- p_REL_ABS_INJ
  
  # Month 2+
  a_UP[REL & INJ, MET & INJ, i]  <- p_REL_MET_INJ
  a_UP[REL & INJ, METC & INJ, i] <- p_REL_METC_INJ
  a_UP[REL & INJ, BUP & INJ, i]  <- p_REL_BUP_INJ
  a_UP[REL & INJ, BUPC & INJ, i] <- p_REL_BUPC_INJ
  a_UP[REL & INJ, ABS & INJ, i]  <- p_REL_ABS_INJ
  ...
  if(checks){
    ...
    write.csv(a_UP_first[, , 4],"checks/UP/a_UP_first_4.csv", row.names = TRUE)
    ...
    write.csv(a_UP[, , 4],"checks/UP/a_UP_4.csv", row.names = TRUE)
  } else{}

  #### Create full time-dependent transition array ####
  # Empty 3-D array
  a_TDP_1 <- a_TDP_2 <- a_TDP_3 <- a_TDP_4 <- array(0, dim = c(n_states, n_states, n_t),
                                              dimnames = list(v_n_states, v_n_states, 1:n_t))
  
  # Add transitions conditional on state-exit (m_leave = 1 - remain)
  # Four transition arrays to account for model-time-varying overdose (2017, 2018, 2019, 2020+)
  ...
  for (i in 1:n_t){
    ...
    a_TDP_4[EP1 & BUP & NI, EP1 & BUP & NI, i]   <- m_remain_4[EP1 & BUP & NI, i]
    # BUPC
    ...
    a_TDP_4[EP1 & BUPC & NI, EP1 & BUPC & NI, i] <- m_remain_4[EP1 & BUPC & NI, i]
    # MET
    ...
    a_TDP_4[EP1 & MET & NI, EP1 & MET & NI, i]   <- m_remain_4[EP1 & MET & NI, i]
    # METC
    ...
    a_TDP_4[EP1 & METC & NI, EP1 & METC & NI, i] <- m_remain_4[EP1 & METC & NI, i]
    # ABS
    ...
    a_TDP_4[EP1 & ABS & NI, EP1 & ABS & NI, i]   <- m_remain_4[EP1 & ABS & NI, i]
    # REL
    ...
    a_TDP_4[EP1 & REL & NI, EP1 & REL & NI, i]   <- m_remain_4[EP1 & REL & NI, i]
    # ODF
    ...
    a_TDP_4[EP1 & ODF & NI, EP1 & ODF & NI, i]   <- m_remain_4[EP1 & ODF & NI, i]
    ...
    a_TDP_4[EP2 & BUP & NI, EP2 & BUP & NI, i] <- m_remain_4[EP2 & BUP & NI, i]
    # BUPC
    ...
    a_TDP_4[EP2 & BUPC & NI, EP2 & BUPC & NI, i] <- m_remain_4[EP2 & BUPC & NI, i]
    # MET
    ...
    a_TDP_4[EP2 & MET & NI, EP2 & MET & NI, i] <- m_remain_4[EP2 & MET & NI, i]
    # METC
    ...
    a_TDP_4[EP2 & METC & NI, EP2 & METC & NI, i] <- m_remain_4[EP2 & METC & NI, i]
    # ABS
    ...
    a_TDP_4[EP2 & ABS & NI, EP2 & ABS & NI, i] <- m_remain_4[EP2 & ABS & NI, i]
    # REL
    ...
    a_TDP_4[EP2 & REL & NI, EP2 & REL & NI, i] <- m_remain_4[EP2 & REL & NI, i]
    # ODF
    ...
    a_TDP_4[EP2 & ODF & NI, EP2 & ODF & NI, i] <- m_remain_4[EP2 & ODF & NI, i]
    ...
    a_TDP_4[EP3 & BUP & NI, EP3 & BUP & NI, i] <- m_remain_4[EP3 & BUP & NI, i]
    # BUPC
    ...
    a_TDP_4[EP3 & BUPC & NI, EP3 & BUPC & NI, i] <- m_remain_4[EP3 & BUPC & NI, i]
    # MET
    ...
    a_TDP_4[EP3 & MET & NI, EP3 & MET & NI, i] <- m_remain_4[EP3 & MET & NI, i]
    # METC
    ...
    a_TDP_4[EP3 & METC & NI, EP3 & METC & NI, i] <- m_remain_4[EP3 & METC & NI, i]
    # ABS
    ...
    a_TDP_4[EP3 & ABS & NI, EP3 & ABS & NI, i] <- m_remain_4[EP3 & ABS & NI, i]
    # REL
    ...
    a_TDP_4[EP3 & REL & NI, EP3 & REL & NI, i] <- m_remain_4[EP3 & REL & NI, i]
    # ODF
    ...
    a_TDP_4[EP3 & ODF & NI, EP3 & ODF & NI, i] <- m_remain_4[EP3 & ODF & NI, i]
    ...
    a_TDP_4[EP1 & BUP & INJ, EP1 & BUP & INJ, i] <- m_remain_4[EP1 & BUP & INJ, i]
    # BUPC
    ...
    a_TDP_4[EP1 & BUPC & INJ, EP1 & BUPC & INJ, i] <- m_remain_4[EP1 & BUPC & INJ, i]
    # MET
    ...
    a_TDP_4[EP1 & MET & INJ, EP1 & MET & INJ, i] <- m_remain_4[EP1 & MET & INJ, i]
    # METC
    ...
    a_TDP_4[EP1 & METC & INJ, EP1 & METC & INJ, i] <- m_remain_4[EP1 & METC & INJ, i]
    # ABS
    ...
    a_TDP_4[EP1 & ABS & INJ, EP1 & ABS & INJ, i] <- m_remain_4[EP1 & ABS & INJ, i]
    # REL
    ...
    a_TDP_4[EP1 & REL & INJ, EP1 & REL & INJ, i] <- m_remain_4[EP1 & REL & INJ, i]
    # ODF
    ...
    a_TDP_4[EP1 & ODF & INJ, EP1 & ODF & INJ, i] <- m_remain_4[EP1 & ODF & INJ, i]
    ...
    a_TDP_4[EP2 & BUP & INJ, EP2 & BUP & INJ, i] <- m_remain_4[EP2 & BUP & INJ, i]
    # BUPC
    ...
    a_TDP_4[EP2 & BUPC & INJ, EP2 & BUPC & INJ, i] <- m_remain_4[EP2 & BUPC & INJ, i]
    # MET
    ...
    a_TDP_4[EP2 & MET & INJ, EP2 & MET & INJ, i] <- m_remain_4[EP2 & MET & INJ, i]
    # METC
    ...
    a_TDP_4[EP2 & METC & INJ, EP2 & METC & INJ, i] <- m_remain_4[EP2 & METC & INJ, i]
    # ABS
    ...
    a_TDP_4[EP2 & ABS & INJ, EP2 & ABS & INJ, i] <- m_remain_4[EP2 & ABS & INJ, i]
    # REL
    ...
    a_TDP_4[EP2 & REL & INJ, EP2 & REL & INJ, i] <- m_remain_4[EP2 & REL & INJ, i]
    # ODF
    ...
    a_TDP_4[EP2 & ODF & INJ, EP2 & ODF & INJ, i] <- m_remain_4[EP2 & ODF & INJ, i]
    ...
    a_TDP_4[EP3 & BUP & INJ, EP3 & BUP & INJ, i] <- m_remain_4[EP3 & BUP & INJ, i]
    # BUPC
    ...
    a_TDP_4[EP3 & BUPC & INJ, EP3 & BUPC & INJ, i] <- m_remain_4[EP3 & BUPC & INJ, i]
    # MET
    ...
    a_TDP_4[EP3 & MET & INJ, EP3 & MET & INJ, i] <- m_remain_4[EP3 & MET & INJ, i]
    # METC
    ...
    a_TDP_4[EP3 & METC & INJ, EP3 & METC & INJ, i] <- m_remain_4[EP3 & METC & INJ, i]
    # ABS
    ...
    a_TDP_4[EP3 & ABS & INJ, EP3 & ABS & INJ, i] <- m_remain_4[EP3 & ABS & INJ, i]
    # REL
    ...
    a_TDP_4[EP3 & REL & INJ, EP3 & REL & INJ, i] <- m_remain_4[EP3 & REL & INJ, i]
    # ODF
    ...
    a_TDP_4[EP3 & ODF & INJ, EP3 & ODF & INJ, i] <- m_remain_4[EP3 & ODF & INJ, i]
  }
  
  if(checks){
    # State transitions pre-overdose
    # First month (state-time)
    write.csv(a_TDP_1[, , 1], "checks/state transitions/a_TDP_pre_OD_2017.csv")
    write.csv(a_TDP_2[, , 1], "checks/state transitions/a_TDP_pre_OD_2018.csv")
    write.csv(a_TDP_3[, , 1], "checks/state transitions/a_TDP_pre_OD_2019.csv")
    write.csv(a_TDP_4[, , 1], "checks/state transitions/a_TDP_pre_OD_2020.csv")
  }
  ...
  if(checks){
    ...
    # First month (state-time)
    write.csv(a_TDP_1[, , 1], "checks/state transitions/a_TDP_post_OD_2017.csv")
    write.csv(a_TDP_2[, , 1], "checks/state transitions/a_TDP_post_OD_2018.csv")
    write.csv(a_TDP_3[, , 1], "checks/state transitions/a_TDP_post_OD_2019.csv")
    write.csv(a_TDP_4[, , 1], "checks/state transitions/a_TDP_post_OD_2020.csv")
  }
  ...
  a_TDP_4[NEG & NI, BUP & NI & NEG, ]  <- a_TDP_4[NEG & NI, BUP & NI & NEG, ] * (1 - p_HIV_BUP_NI - p_HCV_BUP_NI)
  ...
  a_TDP_4[NEG & NI, BUP & NI & HIV, ]  <- a_TDP_4[NEG & NI, BUP & NI & HIV, ] * p_HIV_BUP_NI
  ...
  a_TDP_4[NEG & NI, BUP & NI & HCV, ]  <- a_TDP_4[NEG & NI, BUP & NI & HCV, ] * p_HCV_BUP_NI
  # From HIV
  ...
  a_TDP_4[HIV & NI, BUP & NI & HIV, ]  <- a_TDP_4[HIV & NI, BUP & NI & HIV, ] * (1 - p_HIV_HCV_BUP_NI)
  ...
  a_TDP_4[HIV & NI, BUP & NI & COI, ]  <- a_TDP_4[HIV & NI, BUP & NI & COI, ] * p_HIV_HCV_BUP_NI
  # From HCV
  ...
  a_TDP_4[HCV & NI, BUP & NI & HCV, ]  <- a_TDP_4[HCV & NI, BUP & NI & HCV, ] * (1 - p_HCV_HIV_BUP_NI)
  ...
  a_TDP_4[HCV & NI, BUP & NI & COI, ]  <- a_TDP_4[HCV & NI, BUP & NI & COI, ] * p_HCV_HIV_BUP_NI
  # BUPC
  # From NEG
  ...
  a_TDP_4[NEG & NI, BUPC & NI & NEG, ]  <- a_TDP_4[NEG & NI, BUPC & NI & NEG, ] * (1 - p_HIV_BUPC_NI - p_HCV_BUPC_NI)
  ...
  a_TDP_4[NEG & NI, BUPC & NI & HIV, ]  <- a_TDP_4[NEG & NI, BUPC & NI & HIV, ] * p_HIV_BUPC_NI
  ...
  a_TDP_4[NEG & NI, BUPC & NI & HCV, ]  <- a_TDP_4[NEG & NI, BUPC & NI & HCV, ] * p_HCV_BUPC_NI
  # From HIV
  ...
  a_TDP_4[HIV & NI, BUPC & NI & HIV, ]  <- a_TDP_4[HIV & NI, BUPC & NI & HIV, ] * (1 - p_HIV_HCV_BUPC_NI)
  ...
  a_TDP_4[HIV & NI, BUPC & NI & COI, ]  <- a_TDP_4[HIV & NI, BUPC & NI & COI, ] * p_HIV_HCV_BUPC_NI
  # From HCV
  ...
  a_TDP_4[HCV & NI, BUPC & NI & HCV, ]  <- a_TDP_4[HCV & NI, BUPC & NI & HCV, ] * (1 - p_HCV_HIV_BUPC_NI)
  ...
  a_TDP_4[HCV & NI, BUPC & NI & COI, ]  <- a_TDP_4[HCV & NI, BUPC & NI & COI, ] * p_HCV_HIV_BUPC_NI
  ...
  a_TDP_4[NEG & NI, MET & NI & NEG, ]  <- a_TDP_4[NEG & NI, MET & NI & NEG, ] * (1 - p_HIV_MET_NI - p_HCV_MET_NI)
  ...
  a_TDP_4[NEG & NI, MET & NI & HIV, ]  <- a_TDP_4[NEG & NI, MET & NI & HIV, ] * p_HIV_MET_NI
  ...
  a_TDP_4[NEG & NI, MET & NI & HCV, ]  <- a_TDP_4[NEG & NI, MET & NI & HCV, ] * p_HCV_MET_NI
  # From HIV
  ...
  a_TDP_4[HIV & NI, MET & NI & HIV, ]  <- a_TDP_4[HIV & NI, MET & NI & HIV, ] * (1 - p_HIV_HCV_MET_NI)
  ...
  a_TDP_4[HIV & NI, MET & NI & COI, ]  <- a_TDP_4[HIV & NI, MET & NI & COI, ] * p_HIV_HCV_MET_NI
  # From HCV
  ...
  a_TDP_4[HCV & NI, MET & NI & HCV, ]  <- a_TDP_4[HCV & NI, MET & NI & HCV, ] * (1 - p_HCV_HIV_MET_NI)
  ...
  a_TDP_4[HCV & NI, MET & NI & COI, ]  <- a_TDP_4[HCV & NI, MET & NI & COI, ] * p_HCV_HIV_MET_NI
  ...
  a_TDP_4[NEG & NI, METC & NI & NEG, ]  <- a_TDP_4[NEG & NI, METC & NI & NEG, ] * (1 - p_HIV_METC_NI - p_HCV_METC_NI)
  ...
  a_TDP_4[NEG & NI, METC & NI & HIV, ]  <- a_TDP_4[NEG & NI, METC & NI & HIV, ] * p_HIV_METC_NI
  ...
  a_TDP_4[NEG & NI, METC & NI & HCV, ]  <- a_TDP_4[NEG & NI, METC & NI & HCV, ] * p_HCV_METC_NI
  # From HIV
  ...
  a_TDP_4[HIV & NI, METC & NI & HIV, ]  <- a_TDP_4[HIV & NI, METC & NI & HIV, ] * (1 - p_HIV_HCV_METC_NI)
  ...
  a_TDP_4[HIV & NI, METC & NI & COI, ]  <- a_TDP_4[HIV & NI, METC & NI & COI, ] * p_HIV_HCV_METC_NI
  # From HCV
  ...
  a_TDP_4[HCV & NI, METC & NI & HCV, ]  <- a_TDP_4[HCV & NI, METC & NI & HCV, ] * (1 - p_HCV_HIV_METC_NI)
  ...
  a_TDP_4[HCV & NI, METC & NI & COI, ]  <- a_TDP_4[HCV & NI, METC & NI & COI, ] * p_HCV_HIV_METC_NI
  # REL
  # From NEG
  ...
  a_TDP_4[NEG & NI, REL & NI & NEG, ]  <- a_TDP_4[NEG & NI, REL & NI & NEG, ] * (1 - p_HIV_REL_NI - p_HCV_REL_NI)
  ...
  a_TDP_4[NEG & NI, REL & NI & HIV, ]  <- a_TDP_4[NEG & NI, REL & NI & HIV, ] * p_HIV_REL_NI
  ...
  a_TDP_4[NEG & NI, REL & NI & HCV, ]  <- a_TDP_4[NEG & NI, REL & NI & HCV, ] * p_HCV_REL_NI
  # From HIV
  ...
  a_TDP_4[HIV & NI, REL & NI & HIV, ]  <- a_TDP_4[HIV & NI, REL & NI & HIV, ] * (1 - p_HIV_HCV_REL_NI)
  ...
  a_TDP_4[HIV & NI, REL & NI & COI, ]  <- a_TDP_4[HIV & NI, REL & NI & COI, ] * p_HIV_HCV_REL_NI
  # From HCV
  ...
  a_TDP_4[HCV & NI, REL & NI & HCV, ]  <- a_TDP_4[HCV & NI, REL & NI & HCV, ] * (1 - p_HCV_HIV_REL_NI)
  ...
  a_TDP_4[HCV & NI, REL & NI & COI, ]  <- a_TDP_4[HCV & NI, REL & NI & COI, ] * p_HCV_HIV_REL_NI
  # ODN
  # From NEG
  ...
  a_TDP_4[NEG & NI, ODN & NI & NEG, ]  <- a_TDP_4[NEG & NI, ODN & NI & NEG, ] * (1 - p_HIV_ODN_NI - p_HCV_ODN_NI)
  ...
  a_TDP_4[NEG & NI, ODN & NI & HIV, ]  <- a_TDP_4[NEG & NI, ODN & NI & HIV, ] * p_HIV_ODN_NI
  ...
  a_TDP_4[NEG & NI, ODN & NI & HCV, ]  <- a_TDP_4[NEG & NI, ODN & NI & HCV, ] * p_HCV_ODN_NI
  # From HIV
  ...
  a_TDP_4[HIV & NI, ODN & NI & HIV, ]  <- a_TDP_4[HIV & NI, ODN & NI & HIV, ] * (1 - p_HIV_HCV_ODN_NI)
  ...
  a_TDP_4[HIV & NI, ODN & NI & COI, ]  <- a_TDP_4[HIV & NI, ODN & NI & COI, ] * p_HIV_HCV_ODN_NI
  # From HCV
  ...
  a_TDP_4[HCV & NI, ODN & NI & HCV, ]  <- a_TDP_4[HCV & NI, ODN & NI & HCV, ] * (1 - p_HCV_HIV_ODN_NI)
  ...
  a_TDP_4[HCV & NI, ODN & NI & COI, ]  <- a_TDP_4[HCV & NI, ODN & NI & COI, ] * p_HCV_HIV_ODN_NI
  ...
  a_TDP_4[NEG & NI, ODF & NI & NEG, ]  <- a_TDP_4[NEG & NI, ODF & NI & NEG, ] * 1
  ...
  a_TDP_4[NEG & NI, ODF & NI & HIV, ]  <- a_TDP_4[NEG & NI, ODF & NI & HIV, ] * 0
  ...
  a_TDP_4[NEG & NI, ODF & NI & HCV, ]  <- a_TDP_4[NEG & NI, ODF & NI & HCV, ] * 0
  # From HIV
  ...
  a_TDP_4[HIV & NI, ODF & NI & HIV, ]  <- a_TDP_4[HIV & NI, ODF & NI & HIV, ] * 1
  ...
  a_TDP_4[HIV & NI, ODF & NI & COI, ]  <- a_TDP_4[HIV & NI, ODF & NI & COI, ] * 0
  # From HCV
  ...
  a_TDP_4[HCV & NI, ODF & NI & HCV, ]  <- a_TDP_4[HCV & NI, ODF & NI & HCV, ] * 1
  ...
  a_TDP_4[HCV & NI, ODF & NI & COI, ]  <- a_TDP_4[HCV & NI, ODF & NI & COI, ] * 0
  ...
  a_TDP_4[NEG & NI, ABS & NI & NEG, ]  <- a_TDP_4[NEG & NI, ABS & NI & NEG, ] * (1 - p_HIV_ABS_NI - p_HCV_ABS_NI)
  ...
  a_TDP_4[NEG & NI, ABS & NI & HIV, ]  <- a_TDP_4[NEG & NI, ABS & NI & HIV, ] * p_HIV_ABS_NI
  ...
  a_TDP_4[NEG & NI, ABS & NI & HCV, ]  <- a_TDP_4[NEG & NI, ABS & NI & HCV, ] * p_HCV_ABS_NI
  # From HIV
  ...
  a_TDP_4[HIV & NI, ABS & NI & HIV, ]  <- a_TDP_4[HIV & NI, ABS & NI & HIV, ] * (1 - p_HIV_HCV_ABS_NI)
  ...
  a_TDP_4[HIV & NI, ABS & NI & COI, ]  <- a_TDP_4[HIV & NI, ABS & NI & COI, ] * p_HIV_HCV_ABS_NI
  # From HCV
  ...
  a_TDP_4[HCV & NI, ABS & NI & HCV, ]  <- a_TDP_4[HCV & NI, ABS & NI & HCV, ] * (1 - p_HCV_HIV_ABS_NI)
  ...
  a_TDP_4[HCV & NI, ABS & NI & COI, ]  <- a_TDP_4[HCV & NI, ABS & NI & COI, ] * p_HCV_HIV_ABS_NI
  ...
  a_TDP_4[NEG & INJ, BUP & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, BUP & INJ & NEG, ] * (1 - p_HIV_BUP_INJ - p_HCV_BUP_INJ)
  ...
  a_TDP_4[NEG & INJ, BUP & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, BUP & INJ & HIV, ] * p_HIV_BUP_INJ
  ...
  a_TDP_4[NEG & INJ, BUP & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, BUP & INJ & HCV, ] * p_HCV_BUP_INJ
  # From HIV
  ...
  a_TDP_4[HIV & INJ, BUP & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, BUP & INJ & HIV, ] * (1 - p_HIV_HCV_BUP_INJ)
  ...
  a_TDP_4[HIV & INJ, BUP & INJ & COI, ]  <- a_TDP_4[HIV & INJ, BUP & INJ & COI, ] * p_HIV_HCV_BUP_INJ
  # From HCV
  ...
  a_TDP_4[HCV & INJ, BUP & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, BUP & INJ & HCV, ] * (1 - p_HCV_HIV_BUP_INJ)
  ...
  a_TDP_4[HCV & INJ, BUP & INJ & COI, ]  <- a_TDP_4[HCV & INJ, BUP & INJ & COI, ] * p_HCV_HIV_BUP_INJ
  # BUPC
  # From NEG
  ...
  a_TDP_4[NEG & INJ, BUPC & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, BUPC & INJ & NEG, ] * (1 - p_HIV_BUPC_INJ - p_HCV_BUPC_INJ)
  ...
  a_TDP_4[NEG & INJ, BUPC & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, BUPC & INJ & HIV, ] * p_HIV_BUPC_INJ
  ...
  a_TDP_4[NEG & INJ, BUPC & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, BUPC & INJ & HCV, ] * p_HCV_BUPC_INJ
  # From HIV
  ...
  a_TDP_4[HIV & INJ, BUPC & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, BUPC & INJ & HIV, ] * (1 - p_HIV_HCV_BUPC_INJ)
  ...
  a_TDP_4[HIV & INJ, BUPC & INJ & COI, ]  <- a_TDP_4[HIV & INJ, BUPC & INJ & COI, ] * p_HIV_HCV_BUPC_INJ
  # From HCV
  ...
  a_TDP_4[HCV & INJ, BUPC & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, BUPC & INJ & HCV, ] * (1 - p_HCV_HIV_BUPC_INJ)
  ...
  a_TDP_4[HCV & INJ, BUPC & INJ & COI, ]  <- a_TDP_4[HCV & INJ, BUPC & INJ & COI, ] * p_HCV_HIV_BUPC_INJ
  ...
  a_TDP_4[NEG & INJ, MET & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, MET & INJ & NEG, ] * (1 - p_HIV_MET_INJ - p_HCV_MET_INJ)
  ...
  a_TDP_4[NEG & INJ, MET & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, MET & INJ & HIV, ] * p_HIV_MET_INJ
  ...
  a_TDP_4[NEG & INJ, MET & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, MET & INJ & HCV, ] * p_HCV_MET_INJ
  # From HIV
  ...
  a_TDP_4[HIV & INJ, MET & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, MET & INJ & HIV, ] * (1 - p_HIV_HCV_MET_INJ)
  ...
  a_TDP_4[HIV & INJ, MET & INJ & COI, ]  <- a_TDP_4[HIV & INJ, MET & INJ & COI, ] * p_HIV_HCV_MET_INJ
  # From HCV
  ...
  a_TDP_4[HCV & INJ, MET & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, MET & INJ & HCV, ] * (1 - p_HCV_HIV_MET_INJ)
  ...
  a_TDP_4[HCV & INJ, MET & INJ & COI, ]  <- a_TDP_4[HCV & INJ, MET & INJ & COI, ] * p_HCV_HIV_MET_INJ
  ...
  a_TDP_4[NEG & INJ, METC & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, METC & INJ & NEG, ] * (1 - p_HIV_METC_INJ - p_HCV_METC_INJ)
  ...
  a_TDP_4[NEG & INJ, METC & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, METC & INJ & HIV, ] * p_HIV_METC_INJ
  ...
  a_TDP_4[NEG & INJ, METC & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, METC & INJ & HCV, ] * p_HCV_METC_INJ
  # From HIV
  ...
  a_TDP_4[HIV & INJ, METC & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, METC & INJ & HIV, ] * (1 - p_HIV_HCV_METC_INJ)
  ...
  a_TDP_4[HIV & INJ, METC & INJ & COI, ]  <- a_TDP_4[HIV & INJ, METC & INJ & COI, ] * p_HIV_HCV_METC_INJ
  # From HCV
  ...
  a_TDP_4[HCV & INJ, METC & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, METC & INJ & HCV, ] * (1 - p_HCV_HIV_METC_INJ)
  ...
  a_TDP_4[HCV & INJ, METC & INJ & COI, ]  <- a_TDP_4[HCV & INJ, METC & INJ & COI, ] * p_HCV_HIV_METC_INJ
  # REL
  # From NEG
  ...
  a_TDP_4[NEG & INJ, REL & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, REL & INJ & NEG, ] * (1 - p_HIV_REL_INJ - p_HCV_REL_INJ)
  ...
  a_TDP_4[NEG & INJ, REL & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, REL & INJ & HIV, ] * p_HIV_REL_INJ
  ...
  a_TDP_4[NEG & INJ, REL & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, REL & INJ & HCV, ] * p_HCV_REL_INJ
  # From HIV
  ...
  a_TDP_4[HIV & INJ, REL & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, REL & INJ & HIV, ] * (1 - p_HIV_HCV_REL_INJ)
  ...
  a_TDP_4[HIV & INJ, REL & INJ & COI, ]  <- a_TDP_4[HIV & INJ, REL & INJ & COI, ] * p_HIV_HCV_REL_INJ
  # From HCV
  ...
  a_TDP_4[HCV & INJ, REL & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, REL & INJ & HCV, ] * (1 - p_HCV_HIV_REL_INJ)
  ...
  a_TDP_4[HCV & INJ, REL & INJ & COI, ]  <- a_TDP_4[HCV & INJ, REL & INJ & COI, ] * p_HCV_HIV_REL_INJ
  # ODN
  # From NEG
  ...
  a_TDP_4[NEG & INJ, ODN & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, ODN & INJ & NEG, ] * (1 - p_HIV_ODN_INJ - p_HCV_ODN_INJ)
  ...
  a_TDP_4[NEG & INJ, ODN & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, ODN & INJ & HIV, ] * p_HIV_ODN_INJ
  ...
  a_TDP_4[NEG & INJ, ODN & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, ODN & INJ & HCV, ] * p_HCV_ODN_INJ
  # From HIV
  ...
  a_TDP_4[HIV & INJ, ODN & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, ODN & INJ & HIV, ] * (1 - p_HIV_HCV_ODN_INJ)
  ...
  a_TDP_4[HIV & INJ, ODN & INJ & COI, ]  <- a_TDP_4[HIV & INJ, ODN & INJ & COI, ] * p_HIV_HCV_ODN_INJ
  # From HCV
  ...
  a_TDP_4[HCV & INJ, ODN & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, ODN & INJ & HCV, ] * (1 - p_HCV_HIV_ODN_INJ)
  ...
  a_TDP_4[HCV & INJ, ODN & INJ & COI, ]  <- a_TDP_4[HCV & INJ, ODN & INJ & COI, ] * p_HCV_HIV_ODN_INJ
  ...
  a_TDP_4[NEG & INJ, ODF & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, ODF & INJ & NEG, ] * 1
  ...
  a_TDP_4[NEG & INJ, ODF & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, ODF & INJ & HIV, ] * 0
  ...
  a_TDP_4[NEG & INJ, ODF & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, ODF & INJ & HCV, ] * 0
  # From HIV
  ...
  a_TDP_4[HIV & INJ, ODF & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, ODF & INJ & HIV, ] * 1
  ...
  a_TDP_4[HIV & INJ, ODF & INJ & COI, ]  <- a_TDP_4[HIV & INJ, ODF & INJ & COI, ] * 0
  # From HCV
  ...
  a_TDP_4[HCV & INJ, ODF & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, ODF & INJ & HCV, ] * 1
  ...
  a_TDP_4[HCV & INJ, ODF & INJ & COI, ]  <- a_TDP_4[HCV & INJ, ODF & INJ & COI, ] * 0
  ...
  a_TDP_4[NEG & INJ, ABS & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, ABS & INJ & NEG, ] * (1 - p_HIV_ABS_INJ - p_HCV_ABS_INJ)
  ...
  a_TDP_4[NEG & INJ, ABS & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, ABS & INJ & HIV, ] * p_HIV_ABS_INJ
  ...
  a_TDP_4[NEG & INJ, ABS & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, ABS & INJ & HCV, ] * p_HCV_ABS_INJ
  # From HIV
  ...
  a_TDP_4[HIV & INJ, ABS & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, ABS & INJ & HIV, ] * (1 - p_HIV_HCV_ABS_INJ)
  ...
  a_TDP_4[HIV & INJ, ABS & INJ & COI, ]  <- a_TDP_4[HIV & INJ, ABS & INJ & COI, ] * p_HIV_HCV_ABS_INJ
  # From HCV
  ...
  a_TDP_4[HCV & INJ, ABS & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, ABS & INJ & HCV, ] * (1 - p_HCV_HIV_ABS_INJ)
  ...
  a_TDP_4[HCV & INJ, ABS & INJ & COI, ]  <- a_TDP_4[HCV & INJ, ABS & INJ & COI, ] * p_HCV_HIV_ABS_INJ

  #### Disallowed transitions (ensure that impossible transitions are set to zero) ####
  # Episode rules
  a_TDP_1[EP1, EP3, ] <- a_TDP_2[EP1, EP3, ] <- a_TDP_3[EP1, EP3, ] <- a_TDP_4[EP1, EP3, ] <- 0
  a_TDP_1[EP2, EP1, ] <- a_TDP_2[EP2, EP1, ] <- a_TDP_3[EP2, EP1, ] <- a_TDP_4[EP2, EP1, ] <- 0
  a_TDP_1[EP3, EP1, ] <- a_TDP_2[EP3, EP1, ] <- a_TDP_3[EP3, EP1, ] <- a_TDP_4[EP3, EP1, ] <- 0
  a_TDP_1[EP3, EP2, ] <- a_TDP_2[EP3, EP2, ] <- a_TDP_3[EP3, EP2, ] <- a_TDP_4[EP3, EP2, ] <- 0
  
  # Injection <> Non-injection
  a_TDP_1[INJ, NI,] <- a_TDP_2[INJ, NI,] <- a_TDP_3[INJ, NI,] <- a_TDP_4[INJ, NI,] <- 0
  a_TDP_1[NI, INJ,] <- a_TDP_2[NI, INJ,] <- a_TDP_3[NI, INJ,] <- a_TDP_4[NI, INJ,] <- 0
  
  # Seroconversions
  a_TDP_1[HIV, NEG, ] <- a_TDP_2[HIV, NEG, ] <- a_TDP_3[HIV, NEG, ] <- a_TDP_4[HIV, NEG, ] <- 0
  a_TDP_1[HCV, NEG, ] <- a_TDP_2[HCV, NEG, ] <- a_TDP_3[HCV, NEG, ] <- a_TDP_4[HCV, NEG, ] <- 0
  a_TDP_1[COI, NEG, ] <- a_TDP_2[COI, NEG, ] <- a_TDP_3[COI, NEG, ] <- a_TDP_4[COI, NEG, ] <- 0
  a_TDP_1[HIV, HCV, ] <- a_TDP_2[HIV, HCV, ] <- a_TDP_3[HIV, HCV, ] <- a_TDP_4[HIV, HCV, ] <- 0
  a_TDP_1[HCV, HIV, ] <- a_TDP_2[HCV, HIV, ] <- a_TDP_3[HCV, HIV, ] <- a_TDP_4[HCV, HIV, ] <- 0
  a_TDP_1[COI, HIV, ] <- a_TDP_2[COI, HIV, ] <- a_TDP_3[COI, HIV, ] <- a_TDP_4[COI, HIV, ] <- 0
  a_TDP_1[COI, HCV, ] <- a_TDP_2[COI, HCV, ] <- a_TDP_3[COI, HCV, ] <- a_TDP_4[COI, HCV, ] <- 0
  a_TDP_1[COI, NEG, ] <- a_TDP_2[COI, NEG, ] <- a_TDP_3[COI, NEG, ] <- a_TDP_4[COI, NEG, ] <- 0
  a_TDP_1[NEG, COI, ] <- a_TDP_2[NEG, COI, ] <- a_TDP_3[NEG, COI, ] <- a_TDP_4[NEG, COI, ] <- 0
  
  # Conditional transitions
  # Next episode with out-of-treatment(OOT) EPi -> treatment(TX) EP(i+1)
  a_TDP_1[all_TX & EP1, all_TX & EP2, ] <- a_TDP_2[all_TX & EP1, all_TX & EP2, ] <- a_TDP_3[all_TX & EP1, all_TX & EP2, ] <- a_TDP_4[all_TX & EP1, all_TX & EP2, ] <- 0
  a_TDP_1[all_TX & EP1, all_TX & EP3, ] <- a_TDP_2[all_TX & EP1, all_TX & EP3, ] <- a_TDP_3[all_TX & EP1, all_TX & EP3, ] <- a_TDP_4[all_TX & EP1, all_TX & EP3, ] <- 0
  a_TDP_1[all_TX & EP2, all_TX & EP3, ] <- a_TDP_2[all_TX & EP2, all_TX & EP3, ] <- a_TDP_3[all_TX & EP2, all_TX & EP3, ] <- a_TDP_4[all_TX & EP2, all_TX & EP3, ] <- 0
  a_TDP_1[OOT & EP1, OOT & EP2, ] <- a_TDP_2[OOT & EP1, OOT & EP2, ] <- a_TDP_3[OOT & EP1, OOT & EP2, ] <- a_TDP_4[OOT & EP1, OOT & EP2, ] <- 0
  a_TDP_1[OOT & EP1, OOT & EP3, ] <- a_TDP_2[OOT & EP1, OOT & EP3, ] <- a_TDP_3[OOT & EP1, OOT & EP3, ] <- a_TDP_4[OOT & EP1, OOT & EP3, ] <- 0
  a_TDP_1[OOT & EP2, OOT & EP3, ] <- a_TDP_2[OOT & EP2, OOT & EP3, ] <- a_TDP_3[OOT & EP2, OOT & EP3, ] <- a_TDP_4[OOT & EP2, OOT & EP3, ] <- 0
  a_TDP_1[all_TX & EP1, OOT & EP2, ] <- a_TDP_2[all_TX & EP1, OOT & EP2, ] <- a_TDP_3[all_TX & EP1, OOT & EP2, ] <- a_TDP_4[all_TX & EP1, OOT & EP2, ] <- 0
  a_TDP_1[all_TX & EP2, OOT & EP3, ] <- a_TDP_2[all_TX & EP2, OOT & EP3, ] <- a_TDP_3[all_TX & EP2, OOT & EP3, ] <- a_TDP_4[all_TX & EP2, OOT & EP3, ] <- 0
  a_TDP_1[OOT & EP1, all_TX & EP1, ] <- a_TDP_2[OOT & EP1, all_TX & EP1, ] <- a_TDP_3[OOT & EP1, all_TX & EP1, ] <- a_TDP_4[OOT & EP1, all_TX & EP1, ] <- 0
  a_TDP_1[OOT & EP2, all_TX & EP2, ] <- a_TDP_2[OOT & EP2, all_TX & EP2, ] <- a_TDP_3[OOT & EP2, all_TX & EP2, ] <- a_TDP_4[OOT & EP2, all_TX & EP2, ] <- 0
  
  if(checks){
    # Full array at time = 1
    array_2017_1m <- a_TDP_1[, , 1]
    array_2018_1m <- a_TDP_2[, , 1]
    array_2019_1m <- a_TDP_3[, , 1]
    array_2020_1m <- a_TDP_4[, , 1]
    write.csv(array_2017_1m,"checks/full array/array_2017_1m.csv", row.names = TRUE)
    ...
    array_2017_24m <- a_TDP_1[, , 24]
    array_2018_24m <- a_TDP_2[, , 24]
    array_2019_24m <- a_TDP_3[, , 24]
    array_2020_24m <- a_TDP_4[, , 24]
    write.csv(array_2017_24m,"checks/full array/array_2017_24m.csv", row.names = TRUE)
    ...
    array_2017_last <- a_TDP_1[, , n_t]
    array_2018_last <- a_TDP_2[, , n_t]
    array_2019_last <- a_TDP_3[, , n_t]
    array_2020_last <- a_TDP_4[, , n_t]
    write.csv(array_2017_last,"checks/full array/array_2017_last.csv", row.names = TRUE)
  ...
  # Calbrate over four time points (2017, 2018, 2019, 2020)
  if(cali == TRUE){
    # All model time periods
    # Split into three periods 0-12; 12-24; 24-36; 36+ to account for overall time-varying overdose parameters in calibration
  ...
  write.csv(a_M_trace_4,"checks/full trace array/a_M_trace_4.csv", row.names = TRUE)
  } else{}
